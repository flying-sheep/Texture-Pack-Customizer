		...
		if (img.complete === true) {
			...
			// If width is specified
			 if (params.width && !params.height) {
				params.height = img.width / scaleFac;
			// If height is specified
			} else if (!params.width && params.height) {
				params.width = img.height * scaleFac;
			} else if (!params.width && !params.height) {
				params.width  = img.width;
				params.height = img.height;
			}
			params.x            = params.x            || img.width /2;
			params.y            = params.y            || img.height/2;
			params.sourceX      = params.sourceX      || img.width /2;
			params.sourceY      = params.sourceY      || img.height/2;
			params.sourceWidth  = params.sourceWidth  || img.width;
			params.sourceHeight = params.sourceHeight || img.height;
			// Draw image
			jC.rotate(ctx, params, params.width, params.height);
			ctx.drawImage(img,
				params.sourceX - params.sourceWidth /2,
				params.sourceY - params.sourceHeight/2,
				params.sourceWidth,
				params.sourceHeight,
